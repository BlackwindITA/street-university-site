...
| `img/shot-shack.webp` | **scatto fresco**, come quello del menu. La baracca ora sta sotto `PROGRESS`, quindi la sonda porta il menu fino in fondo e poi chiama `MainMenu._open_baracca()`: non si sta collaudando la navigazione, si sta fotografando una schermata. Lo sfondo del menu è a rotazione fra tre — rilanciare finché il log non dice `scelto: parco_imbrunire`, per non ripetere il tetto già usato nell'eroe |
| `img/shot-city-*.webp`, `shot-cards.webp` | screenshot `STORE_ASSETS/google_play/screenshots/tablet_10` 2560×1440, ridotti 2:1 con filtro BOX a 1280×720, WebP q88. ⚠️ Sono ancora della **versione vecchia** |
